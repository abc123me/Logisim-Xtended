...
public class RGBLed extends InstanceFactory {
	...
	public RGBLed() {
		super("RGB led");
		setIcon(IconGetter.getIcon("RGBLed.png"));
	...
	public void paintInstance(InstancePainter painter) {
		...
		g.fillOval(ledBounds.getX(), ledBounds.getY(), ledBounds.getWidth(), ledBounds.getHeight());
		...
		GraphicsUtil.switchToWidth(g, 2);
		g.drawOval(ledBounds.getX() + 1, ledBounds.getY() + 1, ledBounds.getWidth() - 2, ledBounds.getHeight() - 2);
		painter.drawPorts();
	}
